...
const App = () => {
    ...
    return <div className=' text-gray-200'>
        <div className='text-center text-xs p-2 bg-yellow cl-yellow inset-x-0 top-0 left-0'>This project is just for fun. All data is provided by <a className='cl-blue' href='https://apidocs.cheapshark.com/' target='_blank' rel='noreferrer'>CheapShark API</a></div>
        <div className='flex flex-wrap content-center items-center mt-8'>
            ...
            <div className='flex w-full items-center gap-4 my-4'>
                <p className='w-1/3 text-sm'>Price Ranges</p>
                <input
                    type='number'
                    value={lowerPrice}
            ...
            return <div key={steamAppID} className='bg-dark flex p-2 gap-2 mb-2 border-1 border-gray-600 rounded-sm relative'>
                ...
                <div className='flex items-center justify-end w-1/5'>
                    ...
                    <div className='flex flex-wrap items-center w-1/2 pl-3'>
                        ...
                        <p className='w-full font-normal text-sm'>${salePrice}</p>
                    </div>
                </div>
            </div>;
